d3.select(".home-feature-image").append("div")
    ...
    .html("<br/>" + " What I'm Learning" + "<br/>" + " Online MOOCs and Kaggle Competetions" + "</br/>")

var rect_height = 70
var rect_margin = 10

var viz_heights = {kaggle: 250, course:rect_height*6};
...
var x = d3.time.scale().range([0, width])
        .domain([new Date(2016, 04, 01),new Date(2017, 8, 01)]);
...
var dashboard_svg = d3.select(".home-feature-image")
    ...
    .style("padding-bottom", dash_height/width*100 + "%") /* aspect ratio */
    .append("svg")
    .attr("id","dashboard")
    .attr("viewBox","0 0 1503 " + dash_height)
...
var legend_margin = {top:15,left:10,right:5},
    legend_x = width - 120,
    legend_y = viz_heights.kaggle - 40;
...
function draw_courses(course_data){
    ...
    var wrap_width = 75//handbombing wrap width not ideal...
